package com.web.boom.common.utils;


import com.web.boom.common.config.Constant;
import com.web.boom.common.domain.ColumnDO;
import com.web.boom.common.domain.TableDO;
...
//		}
        ...
        if (template.contains("day_pkg.html.vm")) {
